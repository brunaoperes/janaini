    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <Modal
          ...
          title={`Trocar Senha - ${selectedUser?.nome}`}
          size="sm"
        >
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              Digite a nova senha para o usuário <strong>{selectedUser?.email}</strong>
            </p>
            ...
            {novaSenha && novaSenha.length < 6 && (
              <p className="text-sm text-orange-600">A senha deve ter pelo menos 6 caracteres</p>
            )}
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                ...
                disabled={savingSenha || novaSenha.length < 6 || novaSenha !== confirmaSenha}
                className="flex-1"
              >
